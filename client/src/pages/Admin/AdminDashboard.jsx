  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <p className="text-sm font-semibold text-green-800">Manage Interviews</p>
          <p className="mt-1 text-xs text-green-700">View and triage all interviews.</p>
        </Link>
        <Link
          to="/admin/users"
        ...
        >
          ...
          <p className="mt-1 text-xs text-gray-600">Users, roles, and access.</p>
        </Link>
        <Link
          to="/admin/reports"
          className="bg-white border border-gray-100 rounded-xl p-4 hover:bg-gray-50 transition-colors"
